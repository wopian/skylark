...
<div class="container">
  ...
  <div class="page-header">
    ...
    <div class="col-lg-6 no-gutter">
      ...
      <div id="overview" class="col-sm-6 col-md-6 col-lg-12" style="height: auto; max-width: 570px"></div>
    </div>
    ...
    <div class="col-lg-6 no-gutter">
      ...
      <div id="completed" class="col-sm-6 col-md-6 col-lg-12" style="height: auto; max-width: 570px"></div>
    </div>
    ...
    <div class="col-lg-6 no-gutter">
      ...
      <div id="currently" class="col-sm-6 col-md-6 col-lg-12" style="height: auto; max-width: 570px"></div>
    </div>
    ...
    <div class="col-lg-6 no-gutter">
      ...
      <div id="plan" class="col-sm-6 col-md-6 col-lg-12" style="height: auto; max-width: 570px"></div>
    </div>
