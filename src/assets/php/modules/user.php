...
<div class="cover lazy" data-original="<?= $userCover ?>" style="background-image: url('')"></div>
<div class="user">
  <!--<div class="user-avatar" style="background-image: url('<?= $userAvatar ?>')"></div>-->
  <div class="user-avatar lazy" data-original="<?= $userAvatar ?>" style="background-image: url('')"></div>
