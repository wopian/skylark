...
"hsla")}function r(a){a=/^#?([a-fA-F\d]{1,2})([a-fA-F\d]{1,2})([a-fA-F\d]{1,2})$/g.exec(a);1===a[1].length&&(a[1]=a[1]+""+a[1],a[2]=a[2]+""+a[2],a[3]=a[3]+""+a[3]);a="rgba("+parseInt(a[1],16)+","+parseInt(a[2],16)+","+parseInt(a[3],16)+",1)";return n(a)}for(var p=document.getElementsByTagName("*"),m=0;m<p.length;m++)for(var l=p[m].attributes,e=0;e<l.length;e++)0===l.item(e).nodeName.indexOf("data-")&&(l.item(e).Value=l.item(e).Value.replace(/#([a-z0-9][a-z0-9][a-z0-9][a-z0-9][a-z0-9][a-z0-9]|[a-z0-9][a-z0-9][a-z0-9])/gi,
